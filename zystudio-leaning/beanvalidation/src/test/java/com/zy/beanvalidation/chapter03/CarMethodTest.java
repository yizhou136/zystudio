...
import com.zy.beanvalidation.chapter03.*;
...
public class CarMethodTest {
    ...
    public void validateParameters() throws Exception {
        ...
        method = Vehicle.class.getMethod("getPassengers");
        Set<ConstraintViolation<Vehicle>> vehicleViolations =
                executableValidator.validateReturnValue(object, method, null);
        System.out.println(vehicleViolations);
        assertEquals(1, violations.size());

        List<Passenger> passengerList = new ArrayList<>();
        passengerList.add(new Passenger());
        vehicleViolations =
                executableValidator.validateReturnValue(object, method, passengerList);
        System.out.println(vehicleViolations);
        assertEquals(1, violations.size());
    }
    ...
    public void validateConstructorReturnValue() throws Exception {
        ...
        Car createdObject = new Car("Morris");
